...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["city"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["employment"].'--#--'.GetMessage("WZD_OPTION_3").'--;--edit5--#--'.GetMessage("WZD_OPTION_4").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_5").'--;--edit6--#--'.GetMessage("WZD_OPTION_6").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_7").'--;--cedit1--#--'.GetMessage("WZD_OPTION_8").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_9").'--,--SORT--#--'.GetMessage("WZD_OPTION_10").'--,--CODE--#--'.GetMessage("WZD_OPTION_11").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("VACANCIES_IBLOCK_ID" => $iblockID));
