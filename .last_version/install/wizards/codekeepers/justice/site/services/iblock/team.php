...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["speciality"].'--#--'.GetMessage("WZD_OPTION_3").'--;--cedit3--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["link_Vk"].'--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["link_Instagram"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["link_Twitter"].'--#--'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["link_Facebook"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["link_Youtube"].'--#--'.GetMessage("WZD_OPTION_9").'--;--cedit1--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["skill_show"].'--#--'.GetMessage("WZD_OPTION_11").'--,--PROPERTY_'.$arProperty["skill_title"].'--#--'.GetMessage("WZD_OPTION_12").'--,--cedit1_csection1--#----'.GetMessage("WZD_OPTION_13").'--,--PROPERTY_'.$arProperty["skill1name"].'--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["skill1value"].'--#--'.GetMessage("WZD_OPTION_15").'--,--cedit1_csection2--#----'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["skill2name"].'--#--'.GetMessage("WZD_OPTION_17").'--,--PROPERTY_'.$arProperty["skill2value"].'--#--'.GetMessage("WZD_OPTION_18").'--,--cedit1_csection3--#----'.GetMessage("WZD_OPTION_19").'--,--PROPERTY_'.$arProperty["skill3name"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["skill3value"].'--#--'.GetMessage("WZD_OPTION_21").'--,--cedit1_csection4--#----'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["skill4name"].'--#--'.GetMessage("WZD_OPTION_23").'--,--PROPERTY_'.$arProperty["skill4value"].'--#--'.GetMessage("WZD_OPTION_24").'--,--cedit1_csection5--#----'.GetMessage("WZD_OPTION_25").'--,--PROPERTY_'.$arProperty["skill5name"].'--#--'.GetMessage("WZD_OPTION_26").'--,--PROPERTY_'.$arProperty["skill5value"].'--#--'.GetMessage("WZD_OPTION_27").'--;--edit6--#--'.GetMessage("WZD_OPTION_28").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_29").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_30").'--;--cedit2--#--'.GetMessage("WZD_OPTION_31").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_32").'--,--SORT--#--'.GetMessage("WZD_OPTION_33").'--,--CODE--#--'.GetMessage("WZD_OPTION_34").'--;--";}'));
