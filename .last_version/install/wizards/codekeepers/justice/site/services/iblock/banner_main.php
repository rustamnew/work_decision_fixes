...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["text"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["url"].'--#--'.GetMessage("WZD_OPTION_5").'--,--NAME--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["center"].'--#--'.GetMessage("WZD_OPTION_7").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_8").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_9").'--;--cedit2--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["teasers_show"].'--#--'.GetMessage("WZD_OPTION_11").'--,--cedit2_csection1--#----'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["teaser1_show"].'--#--'.GetMessage("WZD_OPTION_13").'--,--PROPERTY_'.$arProperty["teaser1_icon"].'--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["teaser1_title"].'--#--'.GetMessage("WZD_OPTION_15").'--,--PROPERTY_'.$arProperty["teaser1_url"].'--#--'.GetMessage("WZD_OPTION_16").'--,--cedit2_csection2--#----'.GetMessage("WZD_OPTION_17").'--,--PROPERTY_'.$arProperty["teaser2_show"].'--#--'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["teaser2_icon"].'--#--'.GetMessage("WZD_OPTION_19").'--,--PROPERTY_'.$arProperty["teaser2_title"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["teaser2_url"].'--#--'.GetMessage("WZD_OPTION_21").'--,--cedit2_csection3--#----'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["teaser3_show"].'--#--'.GetMessage("WZD_OPTION_23").'--,--PROPERTY_'.$arProperty["teaser3_icon"].'--#--'.GetMessage("WZD_OPTION_24").'--,--PROPERTY_'.$arProperty["teaser3_title"].'--#--'.GetMessage("WZD_OPTION_25").'--,--PROPERTY_'.$arProperty["teaser3_url"].'--#--'.GetMessage("WZD_OPTION_26").'--,--cedit2_csection4--#----'.GetMessage("WZD_OPTION_27").'--,--PROPERTY_'.$arProperty["teaser4_show"].'--#--'.GetMessage("WZD_OPTION_28").'--,--PROPERTY_'.$arProperty["teaser4_icon"].'--#--'.GetMessage("WZD_OPTION_29").'--,--PROPERTY_'.$arProperty["teaser4_title"].'--#--'.GetMessage("WZD_OPTION_30").'--,--PROPERTY_'.$arProperty["teaser4_url"].'--#--'.GetMessage("WZD_OPTION_31").'--;--cedit1--#--'.GetMessage("WZD_OPTION_32").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_33").'--,--SORT--#--'.GetMessage("WZD_OPTION_34").'--,--CODE--#--'.GetMessage("WZD_OPTION_35").'--;--";}'));
