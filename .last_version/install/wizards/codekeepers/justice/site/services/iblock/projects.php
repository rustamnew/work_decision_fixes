...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/projects.xml"; 
...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit5--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_2").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_3").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_4").'--;--edit6--#--'.GetMessage("WZD_OPTION_5").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_6").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_7").'--;--cedit1--#--'.GetMessage("WZD_OPTION_8").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_9").'--,--SORT--#--'.GetMessage("WZD_OPTION_10").'--,--CODE--#--'.GetMessage("WZD_OPTION_11").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("PROJECTS_IBLOCK_ID" => $iblockID));
