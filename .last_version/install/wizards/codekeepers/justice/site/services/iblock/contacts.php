...
$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID));
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--NAME--#--'.GetMessage("WZD_OPTION_1").'--,--PROPERTY_'.$arProperty["title1"].'--#--'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["title2"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["text"].'--#--'.GetMessage("WZD_OPTION_4").'--,--edit1_csection1--#----'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["title_phone"].'--#--'.GetMessage("WZD_OPTION_6").'--,--PROPERTY_'.$arProperty["icon_phone"].'--#--'.GetMessage("WZD_OPTION_7").'--,--edit1_csection2--#----'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["title_email"].'--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["icon_email"].'--#--'.GetMessage("WZD_OPTION_10").'--,--edit1_csection3--#----'.GetMessage("WZD_OPTION_11").'--,--PROPERTY_'.$arProperty["title_address"].'--#--'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["icon_address"].'--#--'.GetMessage("WZD_OPTION_13").'--;--cedit1--#--'.GetMessage("WZD_OPTION_14").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_15").'--,--SORT--#--'.GetMessage("WZD_OPTION_16").'--,--CODE--#--'.GetMessage("WZD_OPTION_17").'--;--";}'));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("CONTACTS_IBLOCK_ID" => $iblockID));
